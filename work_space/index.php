...
<html lang="fr"> <!-- Pour faire des commentaire-->
	<head>
		...
		<link type="text/css" rel="stylesheet" href="site_styleTvous/css/style_bootstrap.css"/>
	...
	<body id="page1" class="container">
		...
		-->
		<header class="row">
			<nav id="top_page" class="col-xs-12 col-sm-12 col-md-12">
				<ul id="menu">
